  ...
  group('AWSS3Core', () {
    group('profileObject', () {
      test('should generate correct profile object path', () {
        const uid = 'user123';
        final result = AWSS3Core.profileObject(uid);
    ...
    group('postObject', () {
      test('should generate correct post object path', () {
        ...
        final result = AWSS3Core.postObject(uid, postId);
    ...
    group('path consistency', () {
      test('should generate different paths for different users', () {
        ...
        final result1 = AWSS3Core.postObject(uid1, postId);
        final result2 = AWSS3Core.postObject(uid2, postId);
      ...
      test('should generate different paths for different posts', () {
        ...
        final result1 = AWSS3Core.postObject(uid, postId1);
        final result2 = AWSS3Core.postObject(uid, postId2);
      ...
      test('should use same file extension for both methods', () {
        ...
        final profilePath = AWSS3Core.profileObject(uid);
        final postPath = AWSS3Core.postObject(uid, postId);
