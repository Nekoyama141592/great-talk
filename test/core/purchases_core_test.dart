  ...
  group('PurchasesCore', () {
    group('calculate', () {
      test('should calculate discount percentage correctly', () {
        ...
        const expectedX = PurchasesConstants.annualPrice / (PurchasesConstants.monthPrice * 12);
      ...
      test('should handle precision correctly', () {
        ...
        final x = PurchasesConstants.annualPrice / (PurchasesConstants.monthPrice * 12);
        final y = 1.0 - x;
        final z = (y * 100).round();
    ...
    group('edge cases', () {
      ...
      test('should maintain precision in intermediate calculations', () {
        ...
        const x = PurchasesConstants.annualPrice / (PurchasesConstants.monthPrice * 12);
