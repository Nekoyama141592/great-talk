  ...
  group('AuthCore', () {
    ...
    group('consistency tests', () {
      test('should return consistent results for same input', () {
        ...
        final result1 = AuthCore.currentAuthStateString(authUser);
        final result2 = AuthCore.currentAuthStateString(authUser);
    ...
    group('edge cases', () {
      test('should handle multiple different anonymous users', () {
        ...
        final result1 = AuthCore.currentAuthStateString(authUser1);
        final result2 = AuthCore.currentAuthStateString(authUser2);
      ...
      test('should handle transition between states', () {
        ...
        final result1 = AuthCore.currentAuthStateString(nullUser);
