  ...
  group('PurchasesUtil', () {
    group('calculate', () {
      test('should calculate discount percentage correctly', () {
        final result = PurchasesUtil.calculate();
        const expectedX =
      ...
      test('should be consistent across multiple calls', () {
        final result1 = PurchasesUtil.calculate();
        final result2 = PurchasesUtil.calculate();
        final result3 = PurchasesUtil.calculate();
      ...
      test('should represent annual savings percentage', () {
        final discountPercentage = PurchasesUtil.calculate();
