  ...
  group('DateUtil', () {
    group('intToDateTime', () {
      test('should convert int to DateTime correctly', () {
        ...
        final result = DateUtil.intToDateTime(input);
    ...
    group('dateTimeToInt', () {
      test('should convert DateTime to int correctly', () {
        ...
        final result = DateUtil.dateTimeToInt(input);
    ...
    group('conversion consistency', () {
      test(
        ...
        () {
          ...
          final dateTime = DateUtil.intToDateTime(originalInt);
          final convertedInt = DateUtil.dateTimeToInt(dateTime);
      ...
      test(
        ...
        () {
          ...
          final intValue = DateUtil.dateTimeToInt(originalDateTime);
          final convertedDateTime = DateUtil.intToDateTime(intValue);
      ...
      test('should handle multiple conversion cycles', () {
        ...
        final dateTime1 = DateUtil.intToDateTime(originalInt);
        final int1 = DateUtil.dateTimeToInt(dateTime1);
        final dateTime2 = DateUtil.intToDateTime(int1);
        final int2 = DateUtil.dateTimeToInt(dateTime2);
    ...
    group('nowDateTime', () {
      test('should return current timestamp as int', () {
        final result = DateUtil.nowDateTime();
      ...
      test(
        ...
        () async {
          final result1 = DateUtil.nowDateTime();
          await Future.delayed(const Duration(milliseconds: 10));
          final result2 = DateUtil.nowDateTime();
    ...
    group('isCrossingDate', () {
      test('should return false for same date', () {
        ...
        final result = DateUtil.isCrossingDate(date1, date2);
      ...
      test('should handle same exact DateTime', () {
        ...
        final result = DateUtil.isCrossingDate(date, date);
