...
void main() {
  group('SizeCore', () {
    testWidgets('should calculate correct dimensions', (WidgetTester tester) async {
                    ...
                    builder: (context) {
                      return Column(
                        children: [
                          ...
                          Text('User Image Size: ${SizeCore.userImageSize(context)}'),
                          Text('Default Padding: ${SizeCore.defaultPadding(context)}'),
                          Text('Header Text Size: ${SizeCore.defaultHeaderTextSize(context)}'),
                          Text('Tab Text Size: ${SizeCore.defaultTabTextSize(context)}'),
                          Text('App Bar Circular: ${SizeCore.appBarCircular(context)}'),
                          Text('Search Top Padding: ${SizeCore.searchScreenTopPadding(context)}'),
                          Text('Chat Screen Height: ${SizeCore.chatScreenHeight(context)}'),
                        ],
                      );
                    },
                  ),
      ...
      expect(SizeCore.searchScreenTopPadding(context), (800.0 / 100.0) * 7); // 56.0
    ...
    testWidgets('should maintain proportional relationships', (WidgetTester tester) async {
      const screenSize = Size(400, 800);
    ...
    testWidgets('should return positive values for valid screen sizes', (WidgetTester tester) async {
