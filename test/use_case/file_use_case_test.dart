  ...
  group('FileUseCase', () {
    ...
    group('getS3Image', () {
      ...
      test('should return cached image when available', () async {
        ...
        final result = await fileUseCase.getS3Image(testBucketName, testFileName);
        
        expect(result, equals(testImageData));
      });

      test('should fetch from S3 when not cached and cache the result', () async {
        ...
        expect(result, equals(testImageData));
        expect(fakeLocalRepository._cache[testFileName], equals(testImageData));
      });
    ...
    group('caching behavior', () {
      ...
      test('should use cache on second call for same file', () async {
        ...
        final firstResult = await fileUseCase.getS3Image(testBucketName, testFileName);
        ...
        final secondResult = await fileUseCase.getS3Image(testBucketName, testFileName);
    ...
    group('error handling', () {
      ...
      test('should handle cache read errors gracefully', () async {
        ...
        expect(() => fileUseCase.getS3Image(testBucketName, testFileName),
