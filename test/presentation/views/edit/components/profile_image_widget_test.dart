...
void main() {
  group('ProfileImageWidget', () {
    testWidgets('should display default icon when no image is provided', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should display image when base64 data is provided', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should handle null base64 gracefully', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('should have consistent size for image display', (
      WidgetTester tester,
    ) async {
      const String base64Image =
          'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==';
    ...
    testWidgets('should have consistent icon size for no image state', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
