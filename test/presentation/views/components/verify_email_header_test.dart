...
void main() {
  group('VerifyEmailHeader', () {
    testWidgets('should display email icon and title', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: VerifyEmailHeader())),
      );
    ...
    testWidgets('should have correct icon size and color', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: VerifyEmailHeader())),
