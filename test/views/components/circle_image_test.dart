...
void main() {
  group('CircleImage', () {
    ...
    testWidgets('should render person icon when uint8list is null', (WidgetTester tester) async {
    ...
    testWidgets('should render S3Image when uint8list is provided', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: CircleImage(uint8list: testImageData),
          ),
        ),
      );
    ...
    testWidgets('should pass width and height to S3Image correctly', (WidgetTester tester) async {
    ...
    testWidgets('should handle onTap parameter correctly', (WidgetTester tester) async {
      bool tapped = false;
    ...
    testWidgets('should render consistently with different parameters', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Column(
    ...
    testWidgets('should work with valid image data', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: CircleImage(uint8list: testImageData),
    ...
    testWidgets('should handle null image data correctly', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: CircleImage(uint8list: null),
          ),
        ),
      );
    ...
    testWidgets('should handle size parameters consistently', (WidgetTester tester) async {
      const testSize = 80.0;
    ...
    testWidgets('should prefer height over width for S3Image', (WidgetTester tester) async {
      const testWidth = 100.0;
    ...
    testWidgets('should work with ListView and other scrollable widgets', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: ListView(
