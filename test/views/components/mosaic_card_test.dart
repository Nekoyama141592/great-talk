...
void main() {
  group('MosaicCard', () {
    ...
    testWidgets('should handle different child widgets', (WidgetTester tester) async {
      final childWidgets = [
    ...
    testWidgets('should handle complex child layouts', (WidgetTester tester) async {
    ...
    testWidgets('should maintain styling with empty child', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: MosaicCard(
    ...
    testWidgets('should render consistently across rebuilds', (WidgetTester tester) async {
    ...
    group('Visual properties', () {
      testWidgets('should have correct border radius value', (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(
              body: MosaicCard(
      ...
      testWidgets('should have correct shadow properties', (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(
              body: MosaicCard(
