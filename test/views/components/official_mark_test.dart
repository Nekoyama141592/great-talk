...
void main() {
  group('OfficialMark', () {
    testWidgets('should render verified icon with correct properties', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: OfficialMark())),
      );
    ...
    testWidgets('should use theme primary color', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: const Scaffold(body: OfficialMark()),
        ),
      );
    ...
    testWidgets('should maintain consistent size across different themes', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('should have consistent key behavior', (
      ...
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: OfficialMark(key: key))),
      );
    ...
    testWidgets('should maintain visual consistency', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(home: Scaffold(body: OfficialMark())),
    ...
    testWidgets('should render correctly in different screen sizes', (
      WidgetTester tester,
    ) async {
