  ...
  group('SharedPreferencesExtension', () {
    ...
    group('getJson', () {
      ...
      test('should throw exception for invalid JSON', () async {
        ...
        expect(() => prefs.getJson('invalid_key'), throwsA(isA<FormatException>()));
      });
    });
    ...
    group('getJsonList', () {
      ...
      test('should return List<Map<String, dynamic>> when valid JSON array exists', () async {
        const testData = [
          {'id': 1, 'name': 'Item 1'},
          {'id': 2, 'name': 'Item 2'},
          {'id': 3, 'name': 'Item 3'}
      ...
      test('should throw exception for invalid JSON array', () async {
        ...
        expect(() => prefs.getJsonList('invalid_list'), throwsA(isA<FormatException>()));
      });
    });
    ...
    group('getImage', () {
      ...
      test('should throw exception for invalid base64', () async {
        ...
        expect(() => prefs.getImage('invalid_image'), throwsA(isA<FormatException>()));
      });
    });
    ...
    group('error handling', () {
      test('should handle concurrent operations', () async {
        ...
        final futures = List.generate(5, (i) => 
          prefs.setJson('concurrent_$i', {...testData, 'index': i})
        );
