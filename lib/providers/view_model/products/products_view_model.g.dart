...
String _$productsViewModelHash() => r'4306915dcb8a46390826e5924d44836a6ee9a280';

/// See also [ProductsViewModel].
@ProviderFor(ProductsViewModel)
final productsViewModelProvider =
    AsyncNotifierProvider<ProductsViewModel, PurchasesState>.internal(
...
typedef _$ProductsViewModel = AsyncNotifier<PurchasesState>;
