...
class SizeCore {
  ...
  static double userImageSize(BuildContext context) => fullWidth(context) * 0.16;
  static double defaultPadding(BuildContext context) => fullHeight(context) / 100.0;
  static double defaultHeaderTextSize(BuildContext context) =>
      fullHeight(context) / 32.0;
  static double defaultTabTextSize(BuildContext context) => fullHeight(context) / 50.0;
  static double appBarCircular(BuildContext context) => fullHeight(context) / 25.0;
