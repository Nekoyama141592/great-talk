...
class _PostModel extends PostModel {
  const _PostModel({this.bookmarkCount = 0, required this.createdAt, @CustomCompleteTextConverter() required this.customCompleteText, @DetectedTextConverter() required this.description, final  List<Map<String, dynamic>> exampleTexts = const [], this.genre = "", final  List<String> hashTags = const [], @ModeratedImageConverter() required this.image, this.impressionCount = 0, this.likeCount = 0, final  List<Map<String, dynamic>> links = const [], this.msgCount = 0, this.muteCount = 0, required this.postId, this.reportCount = 0, this.score = 0.0, required final  Map<String, dynamic> searchToken, @DetectedTextConverter() required this.title, required this.uid, required this.updatedAt, this.userCount = 0}): _exampleTexts = exampleTexts,_hashTags = hashTags,_links = links,_searchToken = searchToken,super._();
