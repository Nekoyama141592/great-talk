...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReceiptResponse&&const DeepCollectionEquality().equals(other.latestReceipt, latestReceipt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(latestReceipt));
...
/// Create a copy of ReceiptResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? latestReceipt = null,}) {
  return _then(_self.copyWith(
latestReceipt: null == latestReceipt ? _self.latestReceipt : latestReceipt // ignore: cast_nullable_to_non_nullable
as SDMap,
  ));
}
...
class _ReceiptResponse extends ReceiptResponse {
  const _ReceiptResponse({required final  SDMap latestReceipt}): _latestReceipt = latestReceipt,super._();
  factory _ReceiptResponse.fromJson(Map<String, dynamic> json) => _$ReceiptResponseFromJson(json);

 final  SDMap _latestReceipt;
@override SDMap get latestReceipt {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReceiptResponse&&const DeepCollectionEquality().equals(other._latestReceipt, _latestReceipt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_latestReceipt));
...
/// Create a copy of ReceiptResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? latestReceipt = null,}) {
  return _then(_ReceiptResponse(
latestReceipt: null == latestReceipt ? _self._latestReceipt : latestReceipt // ignore: cast_nullable_to_non_nullable
as SDMap,
  ));
}
