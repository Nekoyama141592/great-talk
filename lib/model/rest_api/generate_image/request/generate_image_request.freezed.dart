...
mixin _$GenerateImageRequest {
 ...
 String get prompt; String get size;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GenerateImageRequest&&(identical(other.prompt, prompt) || other.prompt == prompt)&&(identical(other.size, size) || other.size == size));
}
...
/// Create a copy of GenerateImageRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? prompt = null,Object? size = null,}) {
...
class _GenerateImageRequest extends GenerateImageRequest {
  const _GenerateImageRequest({required this.prompt, required this.size}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GenerateImageRequest&&(identical(other.prompt, prompt) || other.prompt == prompt)&&(identical(other.size, size) || other.size == size));
}
...
/// Create a copy of GenerateImageRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? prompt = null,Object? size = null,}) {
