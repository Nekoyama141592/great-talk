...
$PutObjectResponseCopyWith<PutObjectResponse> get copyWith => _$PutObjectResponseCopyWithImpl<PutObjectResponse>(this as PutObjectResponse, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PutObjectResponse&&(identical(other.base64Image, base64Image) || other.base64Image == base64Image));
}
...
abstract mixin class $PutObjectResponseCopyWith<$Res>  {
  factory $PutObjectResponseCopyWith(PutObjectResponse value, $Res Function(PutObjectResponse) _then) = _$PutObjectResponseCopyWithImpl;
@useResult
$Res call({
 String base64Image
});
...
class _PutObjectResponse extends PutObjectResponse {
  ...
  factory _PutObjectResponse.fromJson(Map<String, dynamic> json) => _$PutObjectResponseFromJson(json);
...
@pragma('vm:prefer-inline')
_$PutObjectResponseCopyWith<_PutObjectResponse> get copyWith => __$PutObjectResponseCopyWithImpl<_PutObjectResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PutObjectResponseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PutObjectResponse&&(identical(other.base64Image, base64Image) || other.base64Image == base64Image));
}
...
/// @nodoc
abstract mixin class _$PutObjectResponseCopyWith<$Res> implements $PutObjectResponseCopyWith<$Res> {
  factory _$PutObjectResponseCopyWith(_PutObjectResponse value, $Res Function(_PutObjectResponse) _then) = __$PutObjectResponseCopyWithImpl;
@override @useResult
$Res call({
 String base64Image
});
