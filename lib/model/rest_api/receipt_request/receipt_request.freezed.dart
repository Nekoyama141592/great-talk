...
mixin _$ReceiptRequest {
 ...
 Map<String, dynamic> get data; String get uid;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReceiptRequest&&const DeepCollectionEquality().equals(other.data, data)&&(identical(other.uid, uid) || other.uid == uid));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(data),uid);
...
class _ReceiptRequest extends ReceiptRequest {
  const _ReceiptRequest({required final  Map<String, dynamic> data, required this.uid}): _data = data,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReceiptRequest&&const DeepCollectionEquality().equals(other._data, _data)&&(identical(other.uid, uid) || other.uid == uid));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_data),uid);
