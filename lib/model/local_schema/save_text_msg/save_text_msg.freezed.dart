...
mixin _$SaveTextMsg {
 ...
 DateTime get createdAt; String get id; String get messageType; String get posterUid; String get senderUid; SDMap get text;
...
@useResult
$Res call({
 DateTime createdAt, String id, String messageType, String posterUid, String senderUid, SDMap text
});
...
class _SaveTextMsg extends SaveTextMsg {
  const _SaveTextMsg({required this.createdAt, required this.id, required this.messageType, required this.posterUid, required this.senderUid, required final  SDMap text}): _text = text,super._();
