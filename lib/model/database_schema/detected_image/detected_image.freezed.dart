...
$DetectedImageCopyWith<DetectedImage> get copyWith => _$DetectedImageCopyWithImpl<DetectedImage>(this as DetectedImage, _$identity);
...
abstract mixin class $DetectedImageCopyWith<$Res>  {
  factory $DetectedImageCopyWith(DetectedImage value, $Res Function(DetectedImage) _then) = _$DetectedImageCopyWithImpl;
@useResult
$Res call({
...
class _DetectedImage extends DetectedImage {
  const _DetectedImage({this.bucketName = "", final  List<Map<String, dynamic>> moderationLabels = const [], this.moderationModelVersion = "", this.value = ""}): _moderationLabels = moderationLabels,super._();
  factory _DetectedImage.fromJson(Map<String, dynamic> json) => _$DetectedImageFromJson(json);
...
@pragma('vm:prefer-inline')
_$DetectedImageCopyWith<_DetectedImage> get copyWith => __$DetectedImageCopyWithImpl<_DetectedImage>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$DetectedImageToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DetectedImage&&(identical(other.bucketName, bucketName) || other.bucketName == bucketName)&&const DeepCollectionEquality().equals(other._moderationLabels, _moderationLabels)&&(identical(other.moderationModelVersion, moderationModelVersion) || other.moderationModelVersion == moderationModelVersion)&&(identical(other.value, value) || other.value == value));
}
...
/// @nodoc
abstract mixin class _$DetectedImageCopyWith<$Res> implements $DetectedImageCopyWith<$Res> {
  factory _$DetectedImageCopyWith(_DetectedImage value, $Res Function(_DetectedImage) _then) = __$DetectedImageCopyWithImpl;
@override @useResult
$Res call({
 String bucketName, List<Map<String, dynamic>> moderationLabels, String moderationModelVersion, String value
});
