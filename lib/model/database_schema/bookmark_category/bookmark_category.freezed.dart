...
mixin _$BookmarkCategory {
 ...
 dynamic get createdAt; String get id; SDMap get image; String get title; dynamic get ref; dynamic get updatedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BookmarkCategory&&const DeepCollectionEquality().equals(other.createdAt, createdAt)&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other.image, image)&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other.ref, ref)&&const DeepCollectionEquality().equals(other.updatedAt, updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(createdAt),id,const DeepCollectionEquality().hash(image),title,const DeepCollectionEquality().hash(ref),const DeepCollectionEquality().hash(updatedAt));
...
@useResult
$Res call({
 dynamic createdAt, String id, SDMap image, String title, dynamic ref, dynamic updatedAt
});
...
/// Create a copy of BookmarkCategory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = freezed,Object? id = null,Object? image = null,Object? title = null,Object? ref = freezed,Object? updatedAt = freezed,}) {
...
class _BookmarkCategory implements BookmarkCategory {
  const _BookmarkCategory({required this.createdAt, required this.id, required final  SDMap image, required this.title, required this.ref, required this.updatedAt}): _image = image;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BookmarkCategory&&const DeepCollectionEquality().equals(other.createdAt, createdAt)&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other._image, _image)&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other.ref, ref)&&const DeepCollectionEquality().equals(other.updatedAt, updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(createdAt),id,const DeepCollectionEquality().hash(_image),title,const DeepCollectionEquality().hash(ref),const DeepCollectionEquality().hash(updatedAt));
...
/// Create a copy of BookmarkCategory
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? createdAt = freezed,Object? id = null,Object? image = null,Object? title = null,Object? ref = freezed,Object? updatedAt = freezed,}) {
