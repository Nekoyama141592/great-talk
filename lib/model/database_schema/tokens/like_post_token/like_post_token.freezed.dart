...
mixin _$LikePostToken {
 ...
 String get activeUid; dynamic get createdAt; String get passiveUid; dynamic get postRef; String get postId; String get tokenId; String get tokenType;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,activeUid,const DeepCollectionEquality().hash(createdAt),passiveUid,const DeepCollectionEquality().hash(postRef),postId,tokenId,tokenType);
...
@useResult
$Res call({
 String activeUid, dynamic createdAt, String passiveUid, dynamic postRef, String postId, String tokenId, String tokenType
});
...
/// Create a copy of LikePostToken
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? activeUid = null,Object? createdAt = freezed,Object? passiveUid = null,Object? postRef = freezed,Object? postId = null,Object? tokenId = null,Object? tokenType = null,}) {
...
class _LikePostToken implements LikePostToken {
  const _LikePostToken({required this.activeUid, required this.createdAt, required this.passiveUid, required this.postRef, required this.postId, required this.tokenId, required this.tokenType});
...
/// Create a copy of LikePostToken
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? activeUid = null,Object? createdAt = freezed,Object? passiveUid = null,Object? postRef = freezed,Object? postId = null,Object? tokenId = null,Object? tokenType = null,}) {
