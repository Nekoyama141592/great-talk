...
$ReportPostTokenCopyWith<ReportPostToken> get copyWith => _$ReportPostTokenCopyWithImpl<ReportPostToken>(this as ReportPostToken, _$identity);
...
abstract mixin class $ReportPostTokenCopyWith<$Res>  {
  factory $ReportPostTokenCopyWith(ReportPostToken value, $Res Function(ReportPostToken) _then) = _$ReportPostTokenCopyWithImpl;
@useResult
$Res call({
...
class _ReportPostToken implements ReportPostToken {
  const _ReportPostToken({required this.activeUid, required this.createdAt, required this.postId, required this.postRef, required this.tokenId, required this.tokenType});
  factory _ReportPostToken.fromJson(Map<String, dynamic> json) => _$ReportPostTokenFromJson(json);
...
@pragma('vm:prefer-inline')
_$ReportPostTokenCopyWith<_ReportPostToken> get copyWith => __$ReportPostTokenCopyWithImpl<_ReportPostToken>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ReportPostTokenToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReportPostToken&&(identical(other.activeUid, activeUid) || other.activeUid == activeUid)&&const DeepCollectionEquality().equals(other.createdAt, createdAt)&&(identical(other.postId, postId) || other.postId == postId)&&const DeepCollectionEquality().equals(other.postRef, postRef)&&(identical(other.tokenId, tokenId) || other.tokenId == tokenId)&&(identical(other.tokenType, tokenType) || other.tokenType == tokenType));
}
...
/// @nodoc
abstract mixin class _$ReportPostTokenCopyWith<$Res> implements $ReportPostTokenCopyWith<$Res> {
  factory _$ReportPostTokenCopyWith(_ReportPostToken value, $Res Function(_ReportPostToken) _then) = __$ReportPostTokenCopyWithImpl;
@override @useResult
$Res call({
 String activeUid, dynamic createdAt, String postId, dynamic postRef, String tokenId, String tokenType
});
