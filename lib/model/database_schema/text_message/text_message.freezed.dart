...
mixin _$TextMessage {
 ...
 dynamic get createdAt; String get id; String get messageType; dynamic get messageRef; dynamic get postRef; String get posterUid; String get senderUid; SDMap get text;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TextMessage&&const DeepCollectionEquality().equals(other.createdAt, createdAt)&&(identical(other.id, id) || other.id == id)&&(identical(other.messageType, messageType) || other.messageType == messageType)&&const DeepCollectionEquality().equals(other.messageRef, messageRef)&&const DeepCollectionEquality().equals(other.postRef, postRef)&&(identical(other.posterUid, posterUid) || other.posterUid == posterUid)&&(identical(other.senderUid, senderUid) || other.senderUid == senderUid)&&const DeepCollectionEquality().equals(other.text, text));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(createdAt),id,messageType,const DeepCollectionEquality().hash(messageRef),const DeepCollectionEquality().hash(postRef),posterUid,senderUid,const DeepCollectionEquality().hash(text));
...
@useResult
$Res call({
 dynamic createdAt, String id, String messageType, dynamic messageRef, dynamic postRef, String posterUid, String senderUid, SDMap text
});
...
/// Create a copy of TextMessage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? createdAt = freezed,Object? id = null,Object? messageType = null,Object? messageRef = freezed,Object? postRef = freezed,Object? posterUid = null,Object? senderUid = null,Object? text = null,}) {
  return _then(_self.copyWith(
createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as dynamic,id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,messageType: null == messageType ? _self.messageType : messageType // ignore: cast_nullable_to_non_nullable
as String,messageRef: freezed == messageRef ? _self.messageRef : messageRef // ignore: cast_nullable_to_non_nullable
as dynamic,postRef: freezed == postRef ? _self.postRef : postRef // ignore: cast_nullable_to_non_nullable
...
class _TextMessage extends TextMessage {
  const _TextMessage({required this.createdAt, required this.id, required this.messageType, this.messageRef, this.postRef, required this.posterUid, required this.senderUid, required final  SDMap text}): _text = text,super._();
...
@override final  dynamic messageRef;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(createdAt),id,messageType,const DeepCollectionEquality().hash(messageRef),const DeepCollectionEquality().hash(postRef),posterUid,senderUid,const DeepCollectionEquality().hash(_text));
...
/// Create a copy of TextMessage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? createdAt = freezed,Object? id = null,Object? messageType = null,Object? messageRef = freezed,Object? postRef = freezed,Object? posterUid = null,Object? senderUid = null,Object? text = null,}) {
