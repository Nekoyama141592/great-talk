...
mixin _$UserUpdateLog {
 ...
 dynamic get logCreatedAt; Map<String, dynamic> get searchToken; String get stringBio; String get stringUserName; String get uid; Map<String, dynamic> get image;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserUpdateLog&&const DeepCollectionEquality().equals(other.logCreatedAt, logCreatedAt)&&const DeepCollectionEquality().equals(other.searchToken, searchToken)&&(identical(other.stringBio, stringBio) || other.stringBio == stringBio)&&(identical(other.stringUserName, stringUserName) || other.stringUserName == stringUserName)&&(identical(other.uid, uid) || other.uid == uid)&&const DeepCollectionEquality().equals(other.image, image));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(logCreatedAt),const DeepCollectionEquality().hash(searchToken),stringBio,stringUserName,uid,const DeepCollectionEquality().hash(image));

@override
String toString() {
  return 'UserUpdateLog(logCreatedAt: $logCreatedAt, searchToken: $searchToken, stringBio: $stringBio, stringUserName: $stringUserName, uid: $uid, image: $image)';
}
...
@useResult
$Res call({
 dynamic logCreatedAt, Map<String, dynamic> searchToken, String stringBio, String stringUserName, String uid, Map<String, dynamic> image
});
...
/// Create a copy of UserUpdateLog
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? logCreatedAt = freezed,Object? searchToken = null,Object? stringBio = null,Object? stringUserName = null,Object? uid = null,Object? image = null,}) {
...
class _UserUpdateLog implements UserUpdateLog {
  const _UserUpdateLog({required this.logCreatedAt, required final  Map<String, dynamic> searchToken, required this.stringBio, required this.stringUserName, required this.uid, required final  Map<String, dynamic> image}): _searchToken = searchToken,_image = image;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserUpdateLog&&const DeepCollectionEquality().equals(other.logCreatedAt, logCreatedAt)&&const DeepCollectionEquality().equals(other._searchToken, _searchToken)&&(identical(other.stringBio, stringBio) || other.stringBio == stringBio)&&(identical(other.stringUserName, stringUserName) || other.stringUserName == stringUserName)&&(identical(other.uid, uid) || other.uid == uid)&&const DeepCollectionEquality().equals(other._image, _image));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(logCreatedAt),const DeepCollectionEquality().hash(_searchToken),stringBio,stringUserName,uid,const DeepCollectionEquality().hash(_image));
...
/// Create a copy of UserUpdateLog
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? logCreatedAt = freezed,Object? searchToken = null,Object? stringBio = null,Object? stringUserName = null,Object? uid = null,Object? image = null,}) {
