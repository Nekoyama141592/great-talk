...
class ModeratedImageConverter implements JsonConverter<ModeratedImage, Map<String, dynamic>> {
  const ModeratedImageConverter();

  @override
  ModeratedImage fromJson(Map<String, dynamic> json) => ModeratedImage.fromJson(json);
