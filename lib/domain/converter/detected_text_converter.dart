...
class DetectedTextConverter implements JsonConverter<DetectedText, Map<String, dynamic>> {
  const DetectedTextConverter();

  @override
  DetectedText fromJson(Map<String, dynamic> json) => DetectedText.fromJson(json);
