...
class CustomCompleteTextConverter implements JsonConverter<CustomCompleteText, Map<String, dynamic>> {
  const CustomCompleteTextConverter();

  @override
  CustomCompleteText fromJson(Map<String, dynamic> json) => CustomCompleteText.fromJson(json);
