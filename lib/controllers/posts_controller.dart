...
//                     onPressed: () => _mutePost(innerContext,post),
//                     child: const BasicBoldText("投稿をミュート")),
//                 CupertinoActionSheetAction(
//                     onPressed: () => _muteUser(innerContext,post),
...
//             ));
//   }
//   void _mutePost(BuildContext innerContext,Post post) async {
...
//   void _muteUser(BuildContext innerContext,Post post) async {
