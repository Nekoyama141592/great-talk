...
class PersonCards extends StatelessWidget {
  ...
  Widget build(context) {
    final PersonsController controller = isProMode ? ProfessionalsController.to : SearchController.to;
    return Scaffold(
      floatingActionButton: Obx(() => FloatingActionButton(
        ...
        child: controller.isSearching.value ? const Icon(Icons.search_off) : const Icon(Icons.search),
      ),),
      body: Obx(() => Container(
        padding: controller.isSearching.value ? EdgeInsets.symmetric(vertical: defaultPadding(context)*7) : null,
          ...
          itemBuilder: ((context, index) {
            ...
            return Padding(
              ...
              child: ListTile(
                ...
                onTap: () => Get.to(ChatPage(person: person,controller: controller,)),
                onLongPress: () => ChatApi.showCleanLocalMsgDialog(person,controller),
              ),
            );
          })
        )),
