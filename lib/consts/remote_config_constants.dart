...
class RemoteConfigConstants {
  static const int appVersion = 193;
  static const freeLimitPerDay = 15; // 一日にできる会話数.
  static const basicLimitPerDay = 10000; // 一日にできる会話数.
  static const premiumLimitPerDay = 1000; // 一日にできる会話数.
