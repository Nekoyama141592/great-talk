...
class UrlApi {
  ...
  static const String _eula = "https://www.apple.com/legal/internet-services/itunes/dev/stdeula/";
  ...
  static const String _tos = "https://www.notion.so/bccd27c2976242958409537ac1cbc31b";
  static final tosUri = Uri.parse(_tos);
  static Future<void> toTosPage() async => await launchUrl(tosUri,mode: LaunchMode.externalApplication);
}